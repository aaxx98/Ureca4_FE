...
export function useGetNotificationsQuery<TData = GetNotificationsQueryResult, TError = unknown>(
	...
	options: {
		query: Partial<UseQueryOptions<GetNotificationsQueryResult, TError, TData>> &
			Pick<DefinedInitialDataOptions<GetNotificationsQueryResult, TError, GetNotificationsQueryResult>, "initialData">;
	},
...
export function useGetNotificationsQuery<TData = GetNotificationsQueryResult, TError = unknown>(
	...
	options?: {
		query?: Partial<UseQueryOptions<GetNotificationsQueryResult, TError, TData>> &
			Pick<UndefinedInitialDataOptions<GetNotificationsQueryResult, TError, GetNotificationsQueryResult>, "initialData">;
	},
	queryClient?: QueryClient,
...
export function useGetUnreadCountQuery<TData = GetUnreadCountQueryResult, TError = unknown>(
	options: {
		query: Partial<UseQueryOptions<GetUnreadCountQueryResult, TError, TData>> &
			Pick<DefinedInitialDataOptions<GetUnreadCountQueryResult, TError, GetUnreadCountQueryResult>, "initialData">;
	},
	queryClient?: QueryClient,
): DefinedUseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
export function useGetUnreadCountQuery<TData = GetUnreadCountQueryResult, TError = unknown>(
	options?: {
		query?: Partial<UseQueryOptions<GetUnreadCountQueryResult, TError, TData>> &
			Pick<UndefinedInitialDataOptions<GetUnreadCountQueryResult, TError, GetUnreadCountQueryResult>, "initialData">;
	},
	queryClient?: QueryClient,
): UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
export function useGetUnreadCountQuery<TData = GetUnreadCountQueryResult, TError = unknown>(
...
export function useGetNotificationSettingsQuery<TData = GetNotificationSettingsQueryResult, TError = unknown>(
	options: {
		query: Partial<UseQueryOptions<GetNotificationSettingsQueryResult, TError, TData>> &
			Pick<DefinedInitialDataOptions<GetNotificationSettingsQueryResult, TError, GetNotificationSettingsQueryResult>, "initialData">;
	},
	queryClient?: QueryClient,
): DefinedUseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
export function useGetNotificationSettingsQuery<TData = GetNotificationSettingsQueryResult, TError = unknown>(
	options?: {
		query?: Partial<UseQueryOptions<GetNotificationSettingsQueryResult, TError, TData>> &
			Pick<UndefinedInitialDataOptions<GetNotificationSettingsQueryResult, TError, GetNotificationSettingsQueryResult>, "initialData">;
	},
	queryClient?: QueryClient,
): UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> };
export function useGetNotificationSettingsQuery<TData = GetNotificationSettingsQueryResult, TError = unknown>(

...
export function useGetEmployeesQuery<TData = GetEmployeesQueryResult, TError = unknown>(
	...
	options: { query: Partial<UseQueryOptions<GetEmployeesQueryResult, TError, TData>> & Pick<DefinedInitialDataOptions<GetEmployeesQueryResult, TError, GetEmployeesQueryResult>, "initialData"> },
	queryClient?: QueryClient,
): DefinedUseQueryResult<TData, TError> & { queryKey: DataTag<readonly unknown[], TData, TError> }
export function useGetEmployeesQuery<TData = GetEmployeesQueryResult, TError = unknown>(
	params?: GetEmployeesParams,
	options?: { query?: Partial<UseQueryOptions<GetEmployeesQueryResult, TError, TData>> & Pick<UndefinedInitialDataOptions<GetEmployeesQueryResult, TError, GetEmployeesQueryResult>, "initialData"> },
	queryClient?: QueryClient,
...
export function useGetEmployeeDetailQuery<TData = GetEmployeeDetailQueryResult, TError = unknown>(
	id: number,
	options: { query: Partial<UseQueryOptions<GetEmployeeDetailQueryResult, TError, TData>> & Pick<DefinedInitialDataOptions<GetEmployeeDetailQueryResult, TError, GetEmployeeDetailQueryResult>, "initialData"> },
	queryClient?: QueryClient,
): DefinedUseQueryResult<TData, TError> & { queryKey: DataTag<readonly unknown[], TData, TError> }
export function useGetEmployeeDetailQuery<TData = GetEmployeeDetailQueryResult, TError = unknown>(
	id: number,
	options?: { query?: Partial<UseQueryOptions<GetEmployeeDetailQueryResult, TError, TData>> & Pick<UndefinedInitialDataOptions<GetEmployeeDetailQueryResult, TError, GetEmployeeDetailQueryResult>, "initialData"> },
	queryClient?: QueryClient,
): UseQueryResult<TData, TError> & { queryKey: DataTag<readonly unknown[], TData, TError> }
export function useGetEmployeeDetailQuery<TData = GetEmployeeDetailQueryResult, TError = unknown>(
	id: number,
...
export function useMutationPutEmployeeQuery<TError = unknown, TContext = unknown>(
	options?: { mutation?: UseMutationOptions<PutEmployeeMutationResult, TError, { id: number; data: AdminEmployeeUpdateRequestDto }, TContext> },
	queryClient?: QueryClient,
...
export function useMutationPostEmployeeQuery<TError = unknown, TContext = unknown>(
	options?: { mutation?: UseMutationOptions<PostEmployeeMutationResult, TError, { data: EmployeeCreateRequestDto }, TContext> },
	queryClient?: QueryClient,
...
export function useMutationPatchEmployeeStatusQuery<TError = unknown, TContext = unknown>(
	options?: { mutation?: UseMutationOptions<PatchEmployeeStatusMutationResult, TError, { empId: number; data: EmployeeStatusUpdateRequestDto }, TContext> },
	queryClient?: QueryClient,

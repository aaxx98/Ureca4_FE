...
export function useGetFilterGroupDetailQuery<TData = GetFilterGroupDetailQueryResult, TError = unknown>(
	id: number,
	options: { query: Partial<UseQueryOptions<GetFilterGroupDetailQueryResult, TError, TData>> & Pick<DefinedInitialDataOptions<GetFilterGroupDetailQueryResult, TError, GetFilterGroupDetailQueryResult>, "initialData"> },
	queryClient?: QueryClient,
): DefinedUseQueryResult<TData, TError> & { queryKey: DataTag<readonly unknown[], TData, TError> }
export function useGetFilterGroupDetailQuery<TData = GetFilterGroupDetailQueryResult, TError = unknown>(
	id: number,
	options?: { query?: Partial<UseQueryOptions<GetFilterGroupDetailQueryResult, TError, TData>> & Pick<UndefinedInitialDataOptions<GetFilterGroupDetailQueryResult, TError, GetFilterGroupDetailQueryResult>, "initialData"> },
	queryClient?: QueryClient,
...
export function useGetMyFilterGroupsQuery<TData = GetMyFilterGroupsQueryResult, TError = unknown>(
	options: { query: Partial<UseQueryOptions<GetMyFilterGroupsQueryResult, TError, TData>> & Pick<DefinedInitialDataOptions<GetMyFilterGroupsQueryResult, TError, GetMyFilterGroupsQueryResult>, "initialData"> },
	queryClient?: QueryClient,
): DefinedUseQueryResult<TData, TError> & { queryKey: DataTag<readonly unknown[], TData, TError> }
export function useGetMyFilterGroupsQuery<TData = GetMyFilterGroupsQueryResult, TError = unknown>(
	options?: { query?: Partial<UseQueryOptions<GetMyFilterGroupsQueryResult, TError, TData>> & Pick<UndefinedInitialDataOptions<GetMyFilterGroupsQueryResult, TError, GetMyFilterGroupsQueryResult>, "initialData"> },
	queryClient?: QueryClient,
): UseQueryResult<TData, TError> & { queryKey: DataTag<readonly unknown[], TData, TError> }
export function useGetMyFilterGroupsQuery<TData = GetMyFilterGroupsQueryResult, TError = unknown>(
...
export function useGetFilterDefinitionsQuery<TData = GetFilterDefinitionsQueryResult, TError = unknown>(
	options: { query: Partial<UseQueryOptions<GetFilterDefinitionsQueryResult, TError, TData>> & Pick<DefinedInitialDataOptions<GetFilterDefinitionsQueryResult, TError, GetFilterDefinitionsQueryResult>, "initialData"> },
	queryClient?: QueryClient,
): DefinedUseQueryResult<TData, TError> & { queryKey: DataTag<readonly unknown[], TData, TError> }
export function useGetFilterDefinitionsQuery<TData = GetFilterDefinitionsQueryResult, TError = unknown>(
	options?: { query?: Partial<UseQueryOptions<GetFilterDefinitionsQueryResult, TError, TData>> & Pick<UndefinedInitialDataOptions<GetFilterDefinitionsQueryResult, TError, GetFilterDefinitionsQueryResult>, "initialData"> },
	queryClient?: QueryClient,
): UseQueryResult<TData, TError> & { queryKey: DataTag<readonly unknown[], TData, TError> }
export function useGetFilterDefinitionsQuery<TData = GetFilterDefinitionsQueryResult, TError = unknown>(
...
export function useMutationPutFilterGroupQuery<TError = unknown, TContext = unknown>(
	options?: { mutation?: UseMutationOptions<PutFilterGroupMutationResult, TError, { id: number; data: FilterGroupUpdateRequest }, TContext> },
	queryClient?: QueryClient,
...
export function useMutationDeleteFilterGroupQuery<TError = unknown, TContext = unknown>(
	options?: { mutation?: UseMutationOptions<DeleteFilterGroupMutationResult, TError, { id: number }, TContext> },
	queryClient?: QueryClient,
...
export function useMutationPutFilterGroupOrderQuery<TError = unknown, TContext = unknown>(
	options?: { mutation?: UseMutationOptions<PutFilterGroupOrderMutationResult, TError, { data: FilterGroupOrderRequest }, TContext> },
	queryClient?: QueryClient,
...
export function useMutationPostFilterGroupQuery<TError = unknown, TContext = unknown>(
	options?: { mutation?: UseMutationOptions<PostFilterGroupMutationResult, TError, { data: FilterGroupCreateRequest }, TContext> },
	queryClient?: QueryClient,

...
export function useGetRandomConsultData1Query<TData = GetRandomConsultData1QueryResult, TError = unknown>(
	options: { query: Partial<UseQueryOptions<GetRandomConsultData1QueryResult, TError, TData>> & Pick<DefinedInitialDataOptions<GetRandomConsultData1QueryResult, TError, GetRandomConsultData1QueryResult>, "initialData"> },
	queryClient?: QueryClient,
): DefinedUseQueryResult<TData, TError> & { queryKey: DataTag<readonly unknown[], TData, TError> }
export function useGetRandomConsultData1Query<TData = GetRandomConsultData1QueryResult, TError = unknown>(
	options?: { query?: Partial<UseQueryOptions<GetRandomConsultData1QueryResult, TError, TData>> & Pick<UndefinedInitialDataOptions<GetRandomConsultData1QueryResult, TError, GetRandomConsultData1QueryResult>, "initialData"> },
	queryClient?: QueryClient,

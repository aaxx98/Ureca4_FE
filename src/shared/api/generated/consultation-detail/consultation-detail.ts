...
/** @summary 상담결과서 상세 조회 */
export function useGetConsultationDetailQuery<
	TData = GetConsultationDetailQueryResult,
	TError = unknown,
>(
	params: GetConsultationDetailParams,
	options: {
		query: Partial<
			UseQueryOptions<GetConsultationDetailQueryResult, TError, TData>
		> &
			Pick<
				DefinedInitialDataOptions<
					GetConsultationDetailQueryResult,
					TError,
					GetConsultationDetailQueryResult
				>,
				"initialData"

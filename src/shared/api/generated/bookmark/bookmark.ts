...
export function useGetManualBookmarksQuery<
	TData = GetManualBookmarksQueryResult,
	TError = unknown,
>(
	options: {
		query: Partial<
			UseQueryOptions<GetManualBookmarksQueryResult, TError, TData>
		> &
			Pick<
				DefinedInitialDataOptions<
					GetManualBookmarksQueryResult,
...
export function useGetManualBookmarkDetailQuery<
	TData = GetManualBookmarkDetailQueryResult,
	TError = unknown,
>(
	manualId: number,
	options: {
		query: Partial<
			UseQueryOptions<GetManualBookmarkDetailQueryResult, TError, TData>
		> &
			Pick<
				DefinedInitialDataOptions<
					GetManualBookmarkDetailQueryResult,
...
export function useGetConsultationBookmarksQuery<
	TData = GetConsultationBookmarksQueryResult,
	TError = unknown,
>(
	options: {
		query: Partial<
			UseQueryOptions<GetConsultationBookmarksQueryResult, TError, TData>
		> &
			Pick<
				DefinedInitialDataOptions<
					GetConsultationBookmarksQueryResult,
...
export function useGetConsultationBookmarkDetailQuery<
	TData = GetConsultationBookmarkDetailQueryResult,
	TError = unknown,
>(
	consultId: number,
	options: {
		query: Partial<
			UseQueryOptions<GetConsultationBookmarkDetailQueryResult, TError, TData>
		> &
			Pick<
				DefinedInitialDataOptions<
					GetConsultationBookmarkDetailQueryResult,
...
export function useMutationPostManualBookmarkQuery<
	TError = unknown,
	TContext = unknown,
>(
	options?: {
...
export function useMutationDeleteManualBookmarkQuery<
	TError = unknown,
	TContext = unknown,
>(
	options?: {
...
export function useMutationPostConsultationBookmarkQuery<
	TError = unknown,
	TContext = unknown,
>(
	options?: {
...
export function useMutationDeleteConsultationBookmarkQuery<
	TError = unknown,
	TContext = unknown,
>(
	options?: {
